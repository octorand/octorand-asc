...
def buy(
    ...
    parent_share = Mul(prime.price.external(app_id), const.parent_market_share)
    ...
    return Seq(
        ...
        func.assert_sender_payment(
            func.get_application_address(prime.parent_application_id.external(app_id)),
            Div(parent_share, Int(100)),
        ...
        InnerTxnBuilder.ExecuteMethodCall(
            app_id=app_id,
            method_signature=gen2_contract_prime_app.buy.method_signature(),
            args=[
                Txn.sender(),
                log,
            ],
