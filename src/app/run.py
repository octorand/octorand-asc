...
def run():
    ...
    write(*gen1_contract_setup.router.compile_program(version=10), "gen1/setup")
    ...
    write(*gen2_contract_setup.router.compile_program(version=10), "gen2/setup")
