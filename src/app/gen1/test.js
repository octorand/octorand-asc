...
(async () => {
    ...
    await require('./command/12_game_archive').execute();
    await require('./command/13_game_call_clean').execute();
    await require('./command/14_main_call_update_game').execute();
    await require('./command/15_main_call_clean').execute();
    await require('./command/06_game_application_read').execute();
})();