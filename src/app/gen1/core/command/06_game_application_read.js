...
exports.execute = async function () {
    try {
        ...
        let data = {
            ...
            app_winner_percentage_1: null,
            app_winner_percentage_2: null,
            app_winner_percentage_3: null,
        };
        ...
        for (let i = 0; i < global.length; i++) {
            ...
            switch (key) {
                case '01':
                    ...
                    break;
                case '02':
                    data.app_winner_1 = connection.baseClient.encodeAddress(value.subarray(0, 32));
                    data.app_winner_2 = connection.baseClient.encodeAddress(value.subarray(32, 64));
                    data.app_winner_3 = connection.baseClient.encodeAddress(value.subarray(64, 96));
                    ...
                    data.app_winner_percentage_1 = connection.baseClient.decodeUint64(value.subarray(108, 110));
                    data.app_winner_percentage_2 = connection.baseClient.decodeUint64(value.subarray(110, 112));
                    data.app_winner_percentage_3 = connection.baseClient.decodeUint64(value.subarray(112, 114));
                    break;
            }
        }
