...
exports.execute = async function () {
    try {
        ...
        if (!market['application_id']) {
            ...
            let approvalProgram = fs.readFileSync('src/build/testnet/gen1/market/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/testnet/gen1/market/clear.teal', 'utf8');
