...
exports.execute = async function () {
    try {
        ...
        if (!storage['application_id']) {
            ...
            let approvalProgram = fs.readFileSync('src/build/testnet/gen2/storage/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/testnet/gen2/storage/clear.teal', 'utf8');
