...
exports.execute = async function () {
    try {
        ...
        if (wallet['application_version'] < version) {
            ...
            let approvalProgram = fs.readFileSync('src/build/testnet/gen2/wallet/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/testnet/gen2/wallet/clear.teal', 'utf8');
