...
exports.execute = async function () {
    try {
        ...
        if (!design['application_id']) {
            ...
            let approvalProgram = fs.readFileSync('src/build/testnet/gen2/design/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/testnet/gen2/design/clear.teal', 'utf8');
