    ...
    try {
        ...
        for (let i = 0; i < contracts.length; i++) {
            ...
            if (application['application_version'] < version) {
                let approvalProgram = fs.readFileSync('src/build/testnet/game/' + contract + '/approval.teal', 'utf8');
                let clearProgram = fs.readFileSync('src/build/testnet/game/' + contract + '/clear.teal', 'utf8');
