...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/launchpad/guardians/item/repaint/contract.json')));

        let application = config['launchpad']['guardians']['contracts']['item']['repaint'];
        ...
        if (!application['repainted']) {
            ...
            config['launchpad']['guardians']['contracts']['item']['repaint'] = application;
