...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/launchpad/guardians/item/optout/contract.json')));

        let application = config['launchpad']['guardians']['contracts']['item']['optout'];
        ...
        if (!application['optout']) {
            ...
            config['launchpad']['guardians']['contracts']['item']['optout'] = application;
