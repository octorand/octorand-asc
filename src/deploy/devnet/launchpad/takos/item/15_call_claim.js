...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/launchpad/takos/item/claim/contract.json')));

        let application = config['launchpad']['takos']['contracts']['item']['claim'];
        ...
        if (!application['claim']) {
            ...
            config['launchpad']['takos']['contracts']['item']['claim'] = application;
