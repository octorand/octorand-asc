...
exports.execute = async function () {
    try {
        ...
        let application = config['launchpad']['takos']['contracts']['item']['legacy'];

        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/devnet/launchpad/takos/item/legacy/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/devnet/launchpad/takos/item/legacy/clear.teal', 'utf8');
            ...
            config['launchpad']['takos']['contracts']['item']['legacy'] = application;
