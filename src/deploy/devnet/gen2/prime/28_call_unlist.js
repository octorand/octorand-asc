...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/unlist/contract.json')));

        let application = config['gen2']['contracts']['prime']['unlist'];
        ...
        if (!application['unmoved']) {
            ...
            config['gen2']['contracts']['prime']['unlist'] = application;
