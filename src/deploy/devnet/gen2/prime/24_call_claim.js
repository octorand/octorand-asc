...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/claim/contract.json')));

        let application = config['gen2']['contracts']['prime']['claim'];
        ...
        if (!application['claim']) {
            ...
            config['gen2']['contracts']['prime']['claim'] = application;
