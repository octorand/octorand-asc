...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/withdraw/contract.json')));

        let application = config['gen2']['contracts']['prime']['withdraw'];
        ...
        if (!application['withdrawn']) {
            ...
            config['gen2']['contracts']['prime']['withdraw'] = application;
