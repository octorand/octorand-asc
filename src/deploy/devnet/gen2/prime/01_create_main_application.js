...
exports.execute = async function () {
    try {
        ...
        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/devnet/gen2/prime/build/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/devnet/gen2/prime/build/clear.teal', 'utf8');
