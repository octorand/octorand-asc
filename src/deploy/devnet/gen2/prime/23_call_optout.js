...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/optout/contract.json')));

        let application = config['gen2']['contracts']['prime']['optout'];
        ...
        if (!application['optout']) {
            ...
            config['gen2']['contracts']['prime']['optout'] = application;
