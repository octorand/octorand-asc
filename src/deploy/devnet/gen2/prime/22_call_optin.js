...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/optin/contract.json')));

        let application = config['gen2']['contracts']['prime']['optin'];
        ...
        if (!application['optin']) {
            ...
            config['gen2']['contracts']['prime']['optin'] = application;
