...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/upgrade/contract.json')));

        let application = config['gen2']['contracts']['prime']['upgrade'];
        ...
        if (!application['upgraded']) {
            ...
            config['gen2']['contracts']['prime']['upgrade'] = application;
