...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/rename/contract.json')));

        let application = config['gen2']['contracts']['prime']['rename'];
        ...
        if (!application['renamed']) {
            ...
            config['gen2']['contracts']['prime']['rename'] = application;
