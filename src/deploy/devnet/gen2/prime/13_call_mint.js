...
exports.execute = async function () {
    try {
        ...
        let contract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/devnet/gen2/prime/mint/contract.json')));

        let application = config['gen2']['contracts']['prime']['mint'];
        ...
        if (!application['minted']) {
            ...
            config['gen2']['contracts']['prime']['mint'] = application;
