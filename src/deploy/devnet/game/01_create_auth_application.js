...
exports.execute = async function () {
    try {
        ...
        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/devnet/game/auth/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/devnet/game/auth/clear.teal', 'utf8');
