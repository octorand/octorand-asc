...
exports.execute = async function () {
    ...
    let vaults = JSON.parse(fs.readFileSync('src/deploy/mainnet/gen1/prime/vaults.json'));
    ...
    let optinContract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/mainnet/gen1/prime/optin/contract.json')));
