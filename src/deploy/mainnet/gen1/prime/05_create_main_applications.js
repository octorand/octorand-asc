...
exports.execute = async function () {
    ...
    for (let i = 0; i < max; i++) {
        ...
        if (!primes[i]['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/mainnet/gen1/prime/build/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/gen1/prime/build/clear.teal', 'utf8');
