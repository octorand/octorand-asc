...
exports.execute = async function () {
    ...
    let events = JSON.parse(fs.readFileSync('src/deploy/mainnet/gen2/prime/events.json'));

    let buyContract = new connection.baseClient.ABIContract(JSON.parse(fs.readFileSync('src/build/mainnet/gen2/prime/buy/contract.json')));
