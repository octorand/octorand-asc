...
exports.execute = async function () {
    ...
    let pager = await helpers.pager(connection.indexerClient.lookupAccountCreatedApplications(connection.gen2.addr), limit, key);
        ...
        for (let j = 0; j < global.length; j++) {
            ...
            switch (key) {
                case 'P1':
                    ...
                    name = value.subarray(104, 120).toString('utf-8').trim();
                    break;
            }
        }
    ...
    fs.writeFileSync('src/deploy/mainnet/gen2/prime/graphics.json', JSON.stringify(graphics, null, 4));
