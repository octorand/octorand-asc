...
exports.execute = async function () {
    ...
    for (let i = 0; i < max; i++) {
        ...
        if (primes[i]['legacy_application_version'] < version) {
            ...
            let approvalProgram = fs.readFileSync('src/build/mainnet/gen2/prime/legacy/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/gen2/prime/legacy/clear.teal', 'utf8');
