...
exports.execute = async function () {
    ...
    for (let i = 0; i < contracts.length; i++) {
        ...
        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/mainnet/launchpad/takos/item/' + contract + '/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/launchpad/takos/item/' + contract + '/clear.teal', 'utf8');
