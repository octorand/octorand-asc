...
exports.execute = async function () {
    ...
    for (let i = 0; i < max; i++) {
        ...
        if (items[i]['legacy_application_version'] < version) {
            ...
            let approvalProgram = fs.readFileSync('src/build/mainnet/launchpad/takos/item/legacy/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/launchpad/takos/item/legacy/clear.teal', 'utf8');
