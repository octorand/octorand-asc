...
exports.execute = async function () {
    try {
        ...
        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/mainnet/game/auth/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/game/auth/clear.teal', 'utf8');
