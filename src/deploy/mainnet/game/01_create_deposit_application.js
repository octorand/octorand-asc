...
exports.execute = async function () {
    try {
        ...
        if (!application['application_id']) {
            let approvalProgram = fs.readFileSync('src/build/mainnet/game/deposit/approval.teal', 'utf8');
            let clearProgram = fs.readFileSync('src/build/mainnet/game/deposit/clear.teal', 'utf8');
